...
> weighs a whole tray, so the enclosure is new from scratch: a hand-drawn blueprint of 2026-09-01
> (**authorship unverified** — see `hardware/README.md`), built in **cintra** and cut **in-house**
> by R, J and D (team, 2026-09-02, after the woodworker route was deferred; this retired the
> 2026-08-28 "woodwork" ruling). Not a 3D print either. R's `prototype.FCStd` visualises the design
> but is **not a spec** — do not cut against it.
>
...
| 11 | Capture a candling image under transillumination | 🟡 | the capture half is closed with FR-01. **The transillumination half is hardware, and that hardware is being rebuilt** — the version 1 enclosure is scrapped, not modified, because the panel forced per-batch candling and a one-egg chamber cannot be widened into a tray. The version 2 blueprint was hand-drawn 2026-09-01, **authorship unverified** (R's FreeCAD file visualises it but is not a spec), and it is a **cintra** build cut **in-house** by R, J and D (team, 2026-09-02, after the woodworker route was deferred). Nothing about this row closes until a rig exists that lights a whole tray evenly |
