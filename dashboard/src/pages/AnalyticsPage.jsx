...
export default function AnalyticsPage() {
  ...
  const insightTone = {
    positive: 'border-forest-200 bg-forest-50 text-forest-800',
    ...
    <div>
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-3">
        <ChartCard
          ...
          action={
            <span className="rounded-md bg-forest-50 px-2 py-1 text-xs font-semibold text-forest-800">
              {aggregation}
            </span>
          }
            ...
            <AreaChart data={volumeData} margin={{ top: 12, right: 8, left: -20, bottom: 0 }}>
              <defs>
                <linearGradient id="volumeFill" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="#116E48" stopOpacity={0.3} />
                  <stop offset="100%" stopColor="#116E48" stopOpacity={0.02} />
                </linearGradient>
              </defs>
        ...
        <ChartCard title="AI Insights">
          <div className="min-h-72 space-y-3">
            ...
            {aiState.status === 'loading' && (
              <div className="grid min-h-52 place-items-center rounded-lg border border-dashed border-forest-200 bg-forest-50 p-6 text-center">
                <div>
                  <RefreshCw className="mx-auto animate-spin text-forest-700" size={22} />
                  <p className="mt-3 font-semibold text-forest-900">Generating AI insights…</p>
            ...
            {aiState.status === 'success' && (
              <div className="space-y-3">
                <div className="rounded-lg border border-forest-200 bg-forest-50 p-3">
                  <p className="font-semibold text-forest-900">{aiState.data.summary}</p>
        ...
        <ChartCard title="Quality Results by Egg Size" className="lg:col-span-2">
          <ResponsiveContainer width="100%" height={250}>
            <BarChart data={qualityBySize} margin={{ top: 8, right: 0, left: -20, bottom: 0 }}>
              ...
              <Tooltip />
              <Legend />
              <Bar dataKey="Good" fill="#1C8258" radius={[4, 4, 0, 0]} />
