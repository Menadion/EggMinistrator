...
import { ChartCard, DemoBadge, PageHeader, StatCard } from '../components/Ui'
...
const analyticsApiUrl = 'http://localhost:3001/api/analytics/insights'
...
export default function AnalyticsPage() {
  ...
  }, [filters, metrics, sizeData, volumeData, spoilageData, hourData])
  ...
  return (
    <div>
      <PageHeader title="Analytics" description={`${selectedScans.length.toLocaleString()} inspections selected • Refreshed ${refreshedLabel}`} actions={<DemoBadge />} />
