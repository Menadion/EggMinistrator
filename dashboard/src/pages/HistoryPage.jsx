    ...
    <div>
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        <div className="grid gap-3 lg:grid-cols-[170px_1fr_150px_150px_auto]">
          <input type="date" value={selectedDate} onChange={(event) => { setSelectedDate(event.target.value); setPage(1) }} className="rounded-lg border border-slate-200 px-3 py-2 text-sm text-slate-600" />
          ...
          <button className="inline-flex items-center justify-center gap-2 rounded-lg bg-forest-800 px-4 py-2 text-sm font-semibold text-white"><Filter size={16} />Filters</button>
        </div>
