...
function ProtectedPage({ children }) {
  ...
  if (isLoading)
    return (
      <main className="grid min-h-screen place-items-center bg-cream-100 text-sm font-semibold text-slate-600">
      ...
      <main className="grid min-h-screen place-items-center bg-cream-100 p-6 text-center">
        <div>
          ...
          <p className="mt-2 text-sm text-slate-600">
            Only administrators can access account management.
          </p>
        </div>
      </main>
    )
